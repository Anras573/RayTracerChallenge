...
public class MaterialTest
{
    ...
    {
        var material = new Material(new Stripe(Color.White, Color.Black))
        {
            Ambient = 1f,
            Diffuse = 0f,
            Specular = 0f
    ...
    public void ReflectivityForTheDefaultMaterial()
    {
        ...
        Assert.Equal(0.0f, material.Reflective);
    }
    ...
    public void TransparencyAndRefractiveIndexForTheDefaultMaterial()
    {
        ...
        Assert.Equal(0.0f, material.Transparency);
        Assert.Equal(1.0f, material.RefractiveIndex);
    }
}